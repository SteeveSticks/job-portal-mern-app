...
const Dashboard = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 auto-rows-auto gap-4 md:gap-6">
      {/* Metric item start */}
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        ...
        <div className="flex items-end justify-between mt-5">
          ...
          <span className="flex items-center gap-1 rounded-xl bg-[#ecfdf3] text-[#039855] dark:bg-[#ecfdf3]/10 dark:text-[#12b76a] py-1 px-2">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        ...
        <div className="flex items-end justify-between mt-5">
          ...
          <span className="flex items-center gap-1 rounded-xl bg-[#fef3f2] text-[#d92d20] dark:bg-[#fef3f2]/10 dark:text-[#f04438] py-1 px-2">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        ...
        <div className="flex items-end justify-between mt-5">
          ...
          <span className="flex items-center gap-1 rounded-xl bg-yellow-100 text-yellow-500 dark:bg-yellow-100/10 py-1 px-2">
